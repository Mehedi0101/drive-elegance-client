        ...
        <>
            {
                cart.length !== 0
                    ...
                    <div className="mt-20 md:px-10 px-5">
                        <h2 className={`md:text-4xl text-3xl font-bold text-center ${dark ? 'text-white' : 'text-black'} mb-10 select-none`}>My Cart</h2>
                                ...
                                cart.map(product =>
                                    <div key={product._id} className="card w-full shadow-xl">
                                        ...
                                        <div className="card-body">
                                            <h2 className={`card-title ${dark ? 'text-white' : 'text-dark1'}`}>
                                                {product.name}
                                                <div className="bg-primary px-2 py-1 text-white text-xs rounded-xl">{product.type}</div>
                                            </h2>
                                            <p className={`mt-2 ${dark ? 'text-[#ffffffc0]' : 'text-dark2'}`}><span className={`font-bold ${dark ? 'text-white' : 'text-dark1'}`}>Price:</span> ${product.price}</p>
                    ...
                    <div className="mt-28 min-h-[50vh] flex flex-col items-center justify-center">
                        <h2 className={`md:text-4xl text-3xl font-bold text-center ${dark ? 'text-white' : 'text-black'} mb-5`}>Your Cart Is Empty</h2>
                    </div>
            }
        </>
