...
const Services = () => {
    return (
        <div className="md:px-10 px-5 mt-28 select-none">
            <h2 className="md:text-4xl text-3xl font-bold text-center text-black mb-10">Additional Services</h2>
