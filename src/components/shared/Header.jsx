    ...
    return (
        <>
            ...
            < div className="hidden md:flex items-center justify-between lg:hidden bg-[#3d3d3d] text-white px-10" >
                ...
                <div className={`${showMenu ? 'flex' : 'hidden'} flex-col absolute top-14 bg-[#000000BB] px-8 py-5 rounded space-y-3 z-10`}>
                    {
                        links
                    }
                </div>
            ...
            < div className="flex md:hidden items-center justify-between lg:hidden bg-[#3d3d3d] text-white px-5" >
                ...
                <div className={`${showMenu ? 'flex' : 'hidden'} flex-col absolute top-16 bg-[#000000BB] px-8 py-5 rounded space-y-3 z-10`}>
                    {
